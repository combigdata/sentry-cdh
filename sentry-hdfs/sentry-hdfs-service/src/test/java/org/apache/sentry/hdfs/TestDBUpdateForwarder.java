...
public class TestDBUpdateForwarder {
  ...
  public void testEmptyListIsReturnedWhenImageNumIsZeroAndNoImagesArePersisted() throws Exception {
    Mockito.when(imageRetriever.getLatestImageID()).thenReturn(ProviderConstants.EMPTY_PATHS_SNAPSHOT_ID);

    List updates = updater.getAllUpdatesFrom(1, ProviderConstants.EMPTY_PATHS_SNAPSHOT_ID);
  ...
  public void testEmptyListIsReturnedWhenImageIsUnusedAndNoDeltaChangesArePersisted() throws Exception {
    Mockito.when(deltaRetriever.getLatestDeltaID()).thenReturn(ProviderConstants.EMPTY_NOTIFICATION_ID);
  ...
  public void testFirstImageSyncIsReturnedWhenImageNumIsZero() throws Exception {
    ...
    List<PathsUpdate> updates = updater.getAllUpdatesFrom(0, ProviderConstants.EMPTY_PATHS_SNAPSHOT_ID);
