            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                TSentryPrivilege _elem57;
                for (int _i58 = 0; _i58 < _set56.size; ++_i58)
                {
                  _elem57 = new TSentryPrivilege();
                  _elem57.read(iprot);
                  struct.privileges.add(_elem57);
                }
                iprot.readSetEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          TSentryPrivilege _elem62;
          for (int _i63 = 0; _i63 < _set61.size; ++_i63)
          {
            _elem62 = new TSentryPrivilege();
            _elem62.read(iprot);
            struct.privileges.add(_elem62);
          }
        }
        struct.setPrivilegesIsSet(true);
      }
