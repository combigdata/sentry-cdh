...
import org.apache.sentry.policy.indexer.IndexerModelAuthorizables;
import org.apache.sentry.policy.indexer.SimpleIndexerPolicyEngine;
...
/**
 * Converts Indexer privileges from and to strings
 */
public  class IndexerTSentryPrivilegeConverter implements TSentryPrivilegeConverter {
  private String component;
  private String service;
  private boolean validate;

  public IndexerTSentryPrivilegeConverter(String component, String service) {
    this(component, service, true);
  }

  public IndexerTSentryPrivilegeConverter(String component, String service, boolean validate) {
  ...
  public TSentryPrivilege fromString(String privilegeStr) throws Exception {
    ...
    for (String authorizable : ProviderConstants.AUTHORIZABLE_SPLITTER.split(privilegeStr)) {
      ...
      IndexerModelAuthorizable authz = IndexerModelAuthorizables.from(keyValue);
      if (authz != null) {
  ...
  private static void validatePrivilegeHierarchy(String privilegeStr) throws Exception {
    List<PrivilegeValidator> validators = SimpleIndexerPolicyEngine.createPrivilegeValidators();
