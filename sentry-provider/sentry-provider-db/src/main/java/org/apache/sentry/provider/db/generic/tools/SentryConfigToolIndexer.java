...
public class SentryConfigToolIndexer {
  ...
  private void convertINIToSentryServiceCmds(String component,
    ...
    context.setValidators(SimpleIndexerPolicyEngine.createPrivilegeValidators());
    ...
    IndexerTSentryPrivilegeConverter converter = new IndexerTSentryPrivilegeConverter(component, service, false);
