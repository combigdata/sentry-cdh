 ...
 */
@PersistenceCapable
public class MSentryUser implements PrivilegePrincipal {
  ...
  public ServiceConstants.SentryPrincipalType getType() {
    return ServiceConstants.SentryPrincipalType.USER;
  }
