...
public interface SentryStoreInterface {
  ...
  /**
   * Get all privileges associated with the authorizable and roles from input roles or input
   * groups
   * @param groups
   * @param activeRoles
   * @param authHierarchy
   ...
   * @throws Exception
   */
  TSentryPrivilegeMap listSentryPrivilegesByAuthorizableForUser(Set<String> userNames,
     TSentryAuthorizable authHierarchy, boolean isAdmin)
     throws Exception;
  ...
  /**
   * True if the given set of group and users have atleast one privilege on the server.
   * @param groups
   * @param users
   * @param roleSet
   * @param server
   ...
   * @throws Exception
   */
  boolean hasAnyServerPrivileges(Set<String> groups, Set<String> users,
   ...
   * @throws Exception
   */
  Set<String> listSentryPrivilegesForProvider(Set<String> groups, Set<String> users,
   ...
   * @throws Exception
   */
  List<SentryOwnerInfo> listOwnersByAuthorizable(final TSentryAuthorizable authorizable)
          throws Exception;
   ...
   *         {@link org.apache.sentry.provider.common.ProviderConstants#EMPTY_CHANGE_ID}
   *         and empty maps.
   * @throws Exception
   */
