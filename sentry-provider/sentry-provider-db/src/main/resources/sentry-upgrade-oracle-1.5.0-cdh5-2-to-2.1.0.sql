SELECT 'Upgrading Sentry store schema from 1.5.0-cdh5-2 to 2.1.0' AS Status from dual;
...
SELECT 'Finished upgrading Sentry store schema from 1.5.0-cdh5-2 to 2.1.0' AS Status from dual;