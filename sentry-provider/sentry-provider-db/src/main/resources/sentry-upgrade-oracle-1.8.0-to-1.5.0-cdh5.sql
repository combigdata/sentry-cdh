SELECT 'Upgrading Sentry store schema from 1.8.0 to 1.5.0-cdh5' AS Status from dual;
...
SELECT 'Finished upgrading Sentry store schema from 1.8.0 to 1.5.0-cdh5' AS Status from dual;
