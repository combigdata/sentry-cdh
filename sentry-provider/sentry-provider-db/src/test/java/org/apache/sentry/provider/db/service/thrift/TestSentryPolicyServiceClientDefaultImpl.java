...
public class TestSentryPolicyServiceClientDefaultImpl {
  ...
  private static TListSentryPrivilegesRequest listSentryPrivilegesRequest(final String requestorUser, final String principalName, final List<? extends Authorizable> authorizable) {
  ...
  public void testListAllRolesPrivileges() throws SentryUserException, TException {
    ...
    response.setPrivilegesMap(new HashMap<String, Set<TSentryPrivilege>>());
    response.setStatus(Status.OK());
