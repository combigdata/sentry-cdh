...
public class TestSentryPolicyServiceClientDefaultImpl {
  ...
  private static TListSentryPrivilegesRequest listSentryPrivilegesRequest(final String requestorUser, final String entityName, final List<? extends Authorizable> authorizable) {
